    ...
    return {
        ...
        , script : {
            ...
            exists : function ( scripts, cback ) {
                if ( scripts === undefined ) return error( 'SCRIPT EXISTS', arguments );
            ...
            , load : function ( script, cback ) {
                if ( script === undefined ) return error( 'SCRIPT LOAD', arguments );
                return encode( 'SCRIPT', 'LOAD', script, null, cback );
            }

            , debug : function ( sw, cback ) {
                if ( sw === undefined ) return error( 'SCRIPT DEBUG', arguments );
                return encode( 'SCRIPT','DEBUG', sw, null, cback );
            }
