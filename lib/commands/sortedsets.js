...
exports.commands = function ( encode, error ) {
    ...
    return {
        ...
        zadd : function ( key, scores, cback ) {
            ...
            switch ( toString( scores ) ) {
                case ooo.obj:
                    list = toArray( scores );
                case ooo.arr:
                    return encode( 'ZADD', key, list, parseInt, cback );
                break;
                default:
                    return error( 'ZADD', arguments );
                break;
        ...
        , zcard : function ( key, cback ) {
            ...
            return encode( 'ZCARD', key, parseInt, cback );
        }
        ...
        , zcount : function ( key, min, max, cback ) {
            ...
            return encode( 'ZCOUNT', key, [ min, max ], parseInt, cback );
        }
        ...
        , zincrby : function ( key, float, member, cback ) {
            ...
            if ( key && member ) {
                ...
                return encode( 'ZINCRBY', key, [ f, member ], parseFloat, cback );
            }
        ...
        , zinterstore : function ( dest, keys, weights, aggregate, cback ) {
            ...
            if ( k && w && ( ( klen = k.length ) === w.length ) ) {
                ...
                return encode( 'ZINTERSTORE', dest, list, parseInt, cback );
            }
        ...
        , zlexcount : function ( key, min, max, cback ) {
            ...
            return encode( 'ZLEXCOUNT', key, [ min, max ], parseInt, cback );
        }
        ...
        , zrank : function ( key, member, cback ) {
            ...
            if ( key && member ) {
                ...
                return encode( 'ZRANK', key, member, parseInt, cback );
            }
        ...
        , zrem : function ( key, members, cback ) {
            ...
            return encode( 'ZREM', key, members, parseInt, cback );
        }
        ...
        , zremrangebylex : function ( key, min, max, cback ) {
            ...
            return encode( 'ZREMRANGEBYLEX', key, [ min, max ], parseInt, cback );
        }
        ...
        , zremrangebyrank : function ( key, start, stop, cback ) {
            ...
            return encode( 'ZREMRANGEBYRANK', key, [ start, stop ], parseInt, cback );
        }
        ...
        , zremrangebyscore : function ( key, min, max, cback ) {
            ...
            return encode( 'ZREMRANGEBYSCORE', key, [ min, max ], parseInt, cback );
        }
        ...
        , zrevrank : function ( key, member, cback ) {
            ...
            if ( key && member ) {
                // NOTE : it returns an integer reply or null/nil ($-1 bulk reply)
                return encode( 'ZREVRANK', key, member, parseInt, cback );
            }
        ...
        , zscore : function ( key, member, cback ) {
            ...
            if ( key && member ) {
                // NOTE : it returns a double precision float, represented as string
                return encode( 'ZSCORE', key, member, parseFloat, cback );
            }
        ...
        , zunionstore : function ( dest, keys, weights, aggregate, cback ) {
            ...
            if ( k && w && ( ( klen = k.length ) === w.length ) ) {
                ...
                return encode( 'ZUNIONSTORE', dest, list, parseInt, cback );
            }
