...
exports.commands = function ( encode, error ) {
    ...
    return {
        ...
        , dbsize : function ( cback ) {
            var me = this
                ;
            return encode( 'DBSIZE', parseInt, cback );
        }
        ...
        , flushall : function ( cback ) {
            var me = this
                ;
            return encode( 'FLUSHALL', parseInt, cback );
        }
        ...
        , lastsave : function ( cback ) {
            var me = this
                ;
            return encode( 'LASTSAVE', parseInt, cback );
        }

        , monitor : function ( cback ) {
            var me = this
                ;
            return encode( 'MONITOR', null, cback );
        }
        ...
        , time : function ( cback ) {
            var me = this
                ...
                ;
            return encode( 'TIME', parseTimeReply, cback );
        }
