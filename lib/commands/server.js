...
exports.commands = function ( encode, error ) {
    ...
    return {
        ...
        , config : {
            ...
            get : function ( key ) {
                // TODO: add utility fn to parse CONFIG GET reply
                var me = this
                    ;
                if ( ! key ) {
        ...
        , debug : {
            ...
            object : function ( key ) {
                // TODO: add utility fn to parse DEBUG OBJECT reply
                var me = this
                    ;
                if ( ! key ) {
        ...
        , info : function ( section ) {
            // TODO: add utility fn to parse INFO reply
            var me = this
                ;
                if ( section ) {
        ...
        , slowlog : {
            ...
            get : function ( value ) {
                ...
                // TODO: add utility fn to parse SLOWLOG GET reply
