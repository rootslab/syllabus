...
exports.commands = function ( encode, error ) {
    ...
    return {
        ...
        del : function ( keys, cback ) {
            ...
            if ( isArray( keys ) ) {
                return encode( 'DEL', keys.slice( 0, 1 ), keys.slice( 1 ), parseInt, cback );
            }
            return encode( 'DEL', keys, parseInt, cback );
        }
        ...
        , exists : function ( key, cback ) {
            ...
            return encode( 'EXISTS', key, parseInt, cback );
        }
        ...
        , expire : function ( key, seconds, cback ) {
            ...
            return encode( 'EXPIRE', key, + seconds, parseInt, cback );
        }
        ...
        , expireat : function ( key, unixtime, cback ) {
            ...
            return encode( 'EXPIREAT', key, tstamp, parseInt, cback );
        }
        ...
        , move : function ( key, db, cback ) {
            ...
            return encode( 'MOVE', key, db, parseInt, cback );
        }
        ...
        , object : {
            ...
            refcount : function ( key, cback ) {
                ...
                return encode( 'OBJECT', 'REFCOUNT', key, parseInt, cback );
            }
            ...
            , idletime : function ( key, cback ) {
                ...
                return encode( 'OBJECT', 'IDLETIME', key, parseInt, cback );
            }
        ...
        , persist : function ( key, cback ) {
            ...
            return encode( 'PERSIST', key, parseInt, cback );
        }
        ...
        , pexpire : function ( key, millis, cback ) {
            ...
            return encode( 'PEXPIRE', key, millis, parseInt, cback );
        }
        ...
        , pexpireat : function ( key, unixtime, cback ) {
            ...
            return encode( 'PEXPIREAT', key, unixtime, parseInt, cback );
        }
        ...
        , pttl : function ( key, cback ) {
            ...
            return encode( 'PTTL', key, parseInt, cback );
        }
        ...
        , rename : function ( key, name, cback ) {
            ...
            return encode( 'RENAME', key, name, parseInt, cback );
        }
        ...
        , renamenx : function ( key, name, cback ) {
            ...
            return encode( 'RENAMENX', key, name, parseInt, cback );
        }
        ...
        , ttl : function ( key, cback ) {
            ...
            return encode( 'TTL', key, parseInt, cback );
        }
