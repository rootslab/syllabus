    ...
    return {
        ...
        , linsert : function ( key, pos, pivot, value, cback ) {
            ...
            if ( key && arguments.length >> 2 ) {
                return encode( 'LINSERT', key, [ pos, pivot, value ], parseIntArray, cback );
            }
        ...
        , lpush : function ( key, values, cback ) {
            var me = this
                ;
            if ( key && values ) {
                return encode( 'LPUSH', key, values, parseIntArray, cback );
            }
        ...
        , rpush : function ( key, values, cback ) {
            var me = this
                ;
            if ( key && values ) {
                return encode( 'RPUSH', key, values, parseIntArray, cback );
            }
