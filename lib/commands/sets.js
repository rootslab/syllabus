    ...
    return {
        ...
        sadd : function ( key, members, cback ) {
            var me = this
                ;
            if ( key && members ) {
                return encode( 'SADD', key, members, parseInt, cback );
            }
        ...
        , scard : function ( key, cback ) {
            ...
            return encode( 'SCARD', key, parseInt, cback );
        }
        ...
        , sdiff : function ( keys, cback ) {
            ...
            if ( isArray( keys ) ) {
                return encode( 'SDIFF', keys.shift(), keys, null, cback );
            }
        ...
        , sinter : function ( keys, cback ) {
            ...
            if ( isArray( keys ) ) {
                return encode( 'SINTER', keys.shift(), keys, null, cback );
            }
        ...
        , sismember : function ( key, member, cback ) {
            ...
            return encode( 'SISMEMBER', key, member, parseInt, cback );
        }
        ...
        , smove : function ( source, dest, member, cback ) {
            var me = this
                ;
            if ( source && dest ) {
                return encode( 'SMOVE', source, [ dest, member ], parseInt, cback );
            }
        ...
        , srem : function ( key, members, cback ) {
            ...
            return encode( 'SREM', key, members, parseInt, cback );
        }
        ...
        , sunion : function ( keys, cback ) {
            ...
            if ( isArray( keys ) ) {
                return encode( 'SUNION', keys.shift(), keys, null, cback );
            }
