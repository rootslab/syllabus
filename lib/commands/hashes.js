    ...
    return {
        ...
        , hincrby : function ( key, field, integer, cback ) {
            var n = integer ? integer : '0'
                , ok = ( key !== undefined ) && ( field !== undefined )
                ;
            if ( ok ) return encode( 'HINCRBY', key, [ field, n ], parseIntArray, cback );
        ...
        , hincrbyfloat : function ( key, field, float, cback ) {
            var n = float ? float : '0'
                , ok = ( key !== undefined ) && ( field !== undefined )
                ;
            if ( ok ) return encode( 'HINCRBYFLOAT', key, [ field, n ], parseFloatArray, cback );
