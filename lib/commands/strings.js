        ...
        , bittop : {
            ...
            and : function ( dest, keys ) {
                ...
                if ( dest && keys ) {
                    ...
                    return encode( 'BITTOP', 'AND', list );
                }
                return error( 'BITTOP AND', arguments );
            }
            ...
            , or : function ( dest, keys ) {
                ...
                if ( dest && keys ) {
                    list = [ dest ].concat( keys );
                    return encode( 'BITTOP', 'OR', list );
                }
                return error( 'BITTOP OR', arguments );
            }
            ...
            , xor : function ( dest, keys ) {
                ...
                if ( dest && keys ) {
                    list = [ dest ].concat( keys );
                    return encode( 'BITTOP', 'XOR', list );
                }
                return error( 'BITTOP XOR', arguments );
            }
            ...
            , not : function ( dest, key ) {
                ...
                if ( dest && key ) {
                    list = [ dest, key ]
                    return encode( 'BITTOP', 'NOT', list );
                }
                return error( 'BITTOP NOT', arguments );
            }
