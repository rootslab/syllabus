...
exports.infos = ( function () {
    ...
    return {
        ...
        , swapdb : {
            rtype : '+'
            , since : '4.0.0'
            , hint :'SWAPDB index index'
            , descr : 'This command swaps two Redis databases, so that immediately \
                      all the clients connected to a given database will see the \
                      data of the other database, and the other way around.'
        }
