...
exports.infos = ( function () {
    ...
    return {
        ...
        , zrevrangebylex : {
            rtype : '*'
            , since : '2.8.9'
            , hint : 'Return a range of members in a sorted set, by lexicographical range, ordered from higher to lower strings'
            , descr : 'ZREVRANGEBYLEX key min max [LIMIT offset count].'
        }
